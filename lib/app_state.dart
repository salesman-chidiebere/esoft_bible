...
class AppState extends StatefulWidget {
  ...
  static _AppStateState of(BuildContext context) {
    return (context.dependOnInheritedWidgetOfExactType<_AppState>() as _AppState).data;
  }
}
...
class _AppStateState extends State<AppState> {
  ...
  _loadPreferences() async {
    ...
    setState(() {
      ...
      this._theme = preferences.getString(PREFS_KEY_THEME) ?? 'orange';
...
class _AppState extends InheritedWidget {
  ...
  static _AppState of(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType<_AppState>() as _AppState;
  }
